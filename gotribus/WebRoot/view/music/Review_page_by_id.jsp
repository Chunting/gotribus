            ...
            <div id="common_maincontent"><!--start common_maincontent-->
            	<div id="review_main"><!--start review_main-->
                	<div id="review_lftcol"><!--start review_lftcol-->
                        ...
                        <div class="review_post"><!--start review_post-->
                            <div class="review_ratting"><!--start review_ratting-->
                            	<h2><a href="${my_domain }/review/musicReview/${thisReview.commentId }.action"><c:out value="${thisReview.commentTitle}" /></a></h2>
                                <div class="rating_icon">
												<c:choose>
                    ...
                    <div id="review_side_bar"><!--start review_side_bar-->
                    	<div class="review_btn"><a href="${my_domain }/review/musicReviewAction/${itemId }.action">Create a Review</a></div>
                    	<div class="review_feature">
                        	<img src="${itemPic}" alt="" width="142" height="217"/>
                            <h3><c:out value="${itemName}" /> <a href="${my_domain}/music/${itemId }.action"><img src="${my_local}/movie/img/tripple_arrow3.jpg" alt="" width="25" height="8" /></a></h3>
                        </div>
                        <div class="rating_widget">
                        	<h2>Seach by Rating <span>(<a href="#"><c:out value="${reviewNumber}" /></a>)</span></h2>
                             <ul>
                            	<li>
                                	<a href="${my_domain}/review/searchByRating/2/${itemId}/5.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/5.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/5.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/5.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/5.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                ...
                                <li>
                                	<a href="${my_domain}/review/searchByRating/2/${itemId}/4.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/4.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/4.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/4.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/4.action"><img src="${my_local}/movie/img/icon_rating2.jpg" alt="" width="12" height="12" /></a>
                                    <span><c:out value="${rateNumber[3]}" /></span>
                                </li>
                                <li>
                                	<a href="${my_domain}/review/searchByRating/2/${itemId}/3.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/3.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/3.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/3.action"><img src="${my_local}/movie/img/icon_rating2.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/3.action"><img src="${my_local}/movie/img/icon_rating2.jpg" alt="" width="12" height="12" /></a>
                                    <span><c:out value="${rateNumber[2]}" /></span>
                                </li>
                                <li>
                                	<a href="${my_domain}/review/searchByRating/2/${itemId}/2.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/2.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/2.action"><img src="${my_local}/movie/img/icon_rating2.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/2.action"><img src="${my_local}/movie/img/icon_rating2.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/2.action"><img src="${my_local}/movie/img/icon_rating2.jpg" alt="" width="12" height="12" /></a>
                                    <span><c:out value="${rateNumber[1]}" /></span>
                                </li>
                                <li>
                                	<a href="${my_domain}/review/searchByRating/2/${itemId}/1.action"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/1.action"><img src="${my_local}/movie/img/icon_rating2.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/1.action"><img src="${my_local}/movie/img/icon_rating2.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/1.action"><img src="${my_local}/movie/img/icon_rating2.jpg" alt="" width="12" height="12" /></a>
                                    <a href="${my_domain}/review/searchByRating/2/${itemId}/1.action"><img src="${my_local}/movie/img/icon_rating2.jpg" alt="" width="12" height="12" /></a>
