...
<head>
	...
	$(document).ready(function() {
		$("input.creat_comment_txt").click(function() {
			if($(this).val() == 'Review Title') {
				$(this).val('');
			}	
		});
		$("input.creat_comment_txt").blur(function() {
			if($(this).val() == '') {
				$(this).val('Review Title');
			}	
		});
		$("textarea.message_comment").click(function() {
			if($(this).val() == 'Review Content') {
				$(this).val('');
			}
		});
		$("textarea.message_comment").blur(function() {
			if($(this).val() == '') {
				$(this).val('Review Content');
			}
		});
	});
	</script>
            	...
            	<div id="album_content" class="create_list"><!--start album_content-->
                    <div id="gallery"><!--start gallery-->
                        ...
                        <div id="create_comment"><!--start create_comment-->
                        	<input type="text" class="creat_comment_txt" name="comment_title" value="Review Title" />
                            <textarea class="message_comment" rows="10" cols="10" name="comment_content">Review Content</textarea>
                            <span>Rate it:</span>
                            <div class="comment_rating">
                            	<div class="rating_align"><div id="score" data-rating="0"></div></div>
                            	<input type="hidden" id="item_rate_id" value="${musicId}" />
                            </div>
                            <div class="comment_btn">
                            	<a href="javascript: comment_action('${my_domain }/review/submitMusicReview/${musicId }.action');">Upload</a>
                                <a class="comment_btn2" href="javascript: comment_action('${my_domain }/review/draftMusicReview/${musicId }.action');">Save as Draft</a>
                            </div>
