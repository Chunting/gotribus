                        ...
                        <div id="persoanal_form"><!--start persoanal_form-->
                        	...
                        	<input type="hidden" value="" id="successful_img_path_small" name="successful_img_path_small" />
                            	<div class="persoanal_inp_field">
                                    ...
                                    <p><input type="text" value="${music.musicName }" name="musicName"/></p>
                                </div>
                               	<div class="persoanal_inp_field">
                                	<label>Singer:</label>
                                    <p><input type="text" value="${music.singer.singerName }" name="musicSinger"/></p>
                                </div>
                                <div class="persoanal_inp_field">
                                	<label>Release Date:</label>
                                    <p><input type="text" value="${music.musicPublishDate}" id="musicDate" name="musicDate"/></p>
                                </div>
                                <div class="persoanal_inp_field">
                                	<label>Category:</label>
                                	<select name="musicTag" > 
								      <option value="action">blue</option> 
								      <option value="adventure">classical</option> 
								      <option value="animation">country</option> 
								      <option value="war">hip hop</option> 
								      <option value="comedy">jazz</option> 
								      <option value="horror">pop</option> 
								      <option value="mystery">r&b</option> 
								      <option value="romance">rock</option> 
								      <option value="thriller">others</option> 
								      </select> 
                                </div>    
                                	<label>Brief Introduction:</label>
                                    <p><textarea rows="15" cols="80" name="musicBrief"><c:out value = "${music.musicBrief }" /></textarea></p>
            ...
            <script type="text/javascript">
           	...
           	<script type="text/javascript">
				$(function() {
					...
					$( '#musicDate').datepicker( "option", "dateFormat", "yy-mm-dd");
				});
				function get(){
