    ...
    <div id="light_box_wrapper"><!--start light_box_wrapper-->
        <div id="light_box_bg"><!--start light_box_bg-->
            ...
            <form action="#">
                ...
                <div class="pop_btn"><a href="gotribus.com/tribuslist/add.action">Add</a><a href="gotribus.com/user/addTribusList/music/{tribusListId}/${singlePageMain.itemId}">Create</a></div>
            </form>
