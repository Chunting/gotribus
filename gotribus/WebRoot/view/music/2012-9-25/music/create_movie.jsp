                        ...
                        <div id="persoanal_form"><!--start persoanal_form-->
                        	...
                        	<form action="" id="movie_edit_form">
                            	...
                            	<div class="persoanal_inp_field">
                                    <p><input type="text" value="${music.musicName }" name="bookName" class="text" /></p>
                                </div>
                                <div class="persoanal_inp_field">
                                    <p><input type="text" value="${music.musicSinger}" name="bookAuthor" class="text" /></p>
                                </div>
                                <div class="persoanal_inp_field">                            	
                                    <p><input type="text" value="Release Date" id="bookDate" name="bookDate" class="text" /></p>
                                </div>
