	...
	<div id="wrapper"><!--start wrapper-->
        ...
        <div id="main_area"><!--start main_area-->
            	...
            	<div id="album_content" class="create_list"><!--start album_content-->
                    <div id="gallery"><!--start gallery-->
                        <div id="persoanal_form"><!--start persoanal_form-->
                        		...
                        		<h2 class="title">Edit a Music</h2>
                        		
                        		
                        	<form action="" id="music_edit_form">
							<p><textarea rows="15" cols="80" class="intro" name="musicBrief"><c:out value = "${singlePageMain.itemBrief}" /></textarea></p>
                            	...
                            	<div class="persoanal_inp_field">
                                    <p><input type="text" value="${singlePageMain.itemName}" id="musicName" name="musicName" class="text" onfocus(this.value='') onblur(this.value='movie name') /></p>
                                </div>
                                <div class="persoanal_inp_field">
                                    <p><input type="text" value="${singlePageMain.singerName}" id="musicSinger" name="musicSinger" class="text" onfocus(this.value='') onblur(this.value='movie name') /></p>
                                	<span class="info">Please separate singers by commas.</span>
                                </div>
                                <div class="persoanal_inp_field">                            	
                                    <p><input type="text" value="${singlePageMain.itemDate}" id="musicDate" name="musicDate" class="text" onfocus(this.value='') onblur(this.value='movie name') /></p>
                               	...
                               	<div class="persoanal_inp_field">
                             		<p><span class="arrow"></span><input type="text" id="category" value="Category" name="category" class="text" onfocus(this.value='') onblur(this.value='movie name') /></p>                             
                                	<div class="bookTag">
								 ...
								 <div class="persoanal_inp_field">
                                    <form method="post" name="form" id="form_upload_1" action="${my_domain}/uploadForm/uploadAction.action" enctype="multipart/form-data" target="hidden_frame">				
                        				...
                        				<div id="div_pic_1" class="pic_border">
                        					<img src="${singlePageMain.itemPic }" alt=""/>
                        				</div>
                        		 ...
                        		 <div class="btn_save"><a href="javascript: saveMusicEdition('${my_domain }/music/saveMusicEdition/${music.musicId }.action');">Save</a></div>
            ...
            <script type="text/javascript">
	            function saveMusicEdition(path){
	                    	...
	                    	$('#music_edit_form').attr("action", path);
