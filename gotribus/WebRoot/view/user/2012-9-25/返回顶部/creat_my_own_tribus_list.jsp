...
<head>
	...
	<title>Welcome to tribus, ${user.userAlias } you can creat your own tribus list</title>
            	...
            	<div id="album_content" class="create_list"><!--start album_content-->
                    <div id="gallery"><!--start gallery-->
                        ...
                        <div id="create_input_field_area"><!--start create_input_field_area-->
                        	<form  id="list_form" action="${no_view_url}tribuslist/add.action">
                                ...
                                <!--div class="creat_search">
                                	<p class="create_txt_field">
									<input type="text" value="Search the name of the movie" onclick="if(this.value=='Search the name of the movie')(this.value='')" onblur="if(this.value=='')(this.value='Search the name of the movie')"  /></p>
                                </div-->
                                <!--div class="list_intro">
                                ...
                                <div class="create_btn_area">
                                    ...
                                    <a href="javascript: add_list();">Done</a>
                                </div>
                            </form>
                            <div id="tribus_list">
                            	<h3>${user.userAlias}’s Tirbus List</h3>
                                <ul>
								<c:forEach items="${list}" var="l">
                                	<li><a href="${no_view_url}tribuslist/classlist/${l.id}.action">${l.name}</a></li>
								</c:forEach>
                                </ul>
                            </div>
