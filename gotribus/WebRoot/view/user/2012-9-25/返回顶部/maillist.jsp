        	...
        	<div id="saerch_area"><!--start saerch_area-->
            	<div id="search_bg"><!--start search_bg-->
                	<form action="${no_view_url}userMail/searchMail.action">
                    	<p class="search_text"><input type="text" name="search" value="" 
                ...
                <div id="social_media"><!--start social_media-->
                	<div id="social_lftcol">
                    	<a href="#"><img src="${domain }user/img/icon_facebook.jpg" 
                	...
                	<div id="search_lftcol"><!--start search_lftcol-->
                        ...
                        <div class="result_list">
		                    ...
		                    <c:forEach items="${lists}" var="trib"> 
                            	<li>								
									<a href="${no_view_url}userMail/messageInfo/${trib.messageId}.action">
									${trib.messageTitle}
                            	</a>  edited by ${trib.messageFromUserAlias}</li>                            	
							</c:forEach>																				
