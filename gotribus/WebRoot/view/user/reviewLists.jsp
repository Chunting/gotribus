            ...
            <div id="common_maincontent"><!--start common_maincontent-->
            	<div id="album_content"><!--start album_content-->
                	<div id="tribus_friend"><!--start tribus_friend-->
                        ...
                        <h2><a href="${no_view_url}user/friendHome/${user.userId}.action">
							${user.userAlias}
						</a></h2>
                    </div><!--//end #tribus_friend-->
                    <div class="tribus_common_box"><!--start tribus_common_box-->
                    	<h2>Movie List</h2>
                        <div class="movie_icoon"><a href="#"><img src="${domain}user/img/icon_plus.jpg" alt="" width="20" height="20" /></a></div>
                    	<ul>          
						<a href="${no_view_url}user/reviewList/2.action">
							${movieCom} movies						
						</a>
                        </ul>
                    ...
                    <div class="tribus_common_box"><!--start tribus_common_box-->
                        ...
                        <div class="movie_icoon"><a href="#"><img src="${domain}user/img/icon_plus.jpg" alt="" width="20" height="20" /></a></div>
                    	<ul>                        								
							<a href="${no_view_url}user/reviewList/3.action">
								${musicCom} music
							</a>	
                        </ul>
                    </div><!--//end .tribus_common_box-->
                    <div class="tribus_common_box margin_null"><!--start tribus_common_box-->
                        ...
                        <div class="movie_icoon"><a href="#"><img src="${domain}user/img/icon_plus.jpg" alt="" width="20" height="20" /></a></div>
                    	<ul>                        	
							<a href="${no_view_url}user/reviewList/1.action">
								${bookCom} books
							</a>
                        </ul>
                    </div><!--//end .tribus_common_box-->
