                	...
                	<div id="search_lftcol"><!--start search_lftcol-->
                        ...
                        <div class="result_list">
		                    ...
		                    <c:forEach items="${list}" var="trib"> 
                            	<li>
								<c:if test="${trib.type == 'movie'}">
									<a href="${no_view_url}movie/${trib.resourceId}.action">
									${trib.wishListName}
                            	</a>  edited by ${trib.user.userAlias}</li>
								</c:if>
								<c:if test="${trib.type == 'music'}">
									<a href="${no_view_url}music/${trib.resourceId}.action">
									${trib.wishListName}
                            	</a>  edited by ${trib.user.userAlias}</li>
								</c:if>
								<c:if test="${trib.type == 'book'}">
									<a href="${no_view_url}book/${trib.resourceId}.action">
									${trib.wishListName}
                            	</a>  edited by ${trib.user.userAlias}</li>
								</c:if>
								<c:if test="${trib.type == 'city'}">
									<a href="${no_view_url}activity/info.action?activityId=${trib.resourceId}">
									${trib.wishListName}
                            	</a>  edited by ${trib.user.userAlias}</li>
								</c:if>
							 ...
							 <c:forEach items="${lists}" var="trib"> 
                            	<li>
								<c:if test="${trib.type == 'movie'}">
									<a href="${no_view_url}movie/${trib.resourceId}.action">
									${trib.resourceName}
