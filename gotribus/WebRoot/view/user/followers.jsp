            ...
            <div id="common_maincontent"><!--start common_maincontent-->
            	<div id="follower_title"><!--start follower_title-->
                    ...
                    <div id="title_follower_row">
                    	<div id="pic_follower"><img src="${domain }user/img/pic_flower1.jpg" alt="" width="78" height="78" /></div>
                        <div id="people_follow">
                        	<p>( <span>${followersNum }</span> ) People followed ${user.userAlias }</p>
                            <a href="#"><img src="${domain }user/img/icon_album.jpg" alt="" width="20" height="19" /></a>
                        </div>
                    </div>
