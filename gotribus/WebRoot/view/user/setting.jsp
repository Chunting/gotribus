...
<head>
	...
	<title>Welcome to Gotribus,${user.userAlias },edit your profile</title>
                            ...
                            <div class="perrsonal_info"><!--start perrsonal_info-->
                                ...
                                <div class="personal_upload">
                                	...
                                	<form method="post" name="form" id="form_upload" action="${no_view_url}uploadForm/uploadAction.action" enctype="multipart/form-data" target="hidden_frame">				
                        				...
                        				<p class="edit_txt">
                        					<input type="file" name="myfile" onchange="$('#form_upload').submit();"   />
                        				</p>
                        				<input type="hidden" value="0" id="file_url" name="file_url" />
                        			</form>
                                ...
                                <div class="persoanl_rgtcol">
                                    ...
                                    <small><a href="#">
                                    <img src="${domain }user/img/icon_album.jpg" alt="" width="20" height="19" /></a></small>
                                </div>
                        	...
                        	<form action="${no_view_url}/user/editAction/${user.userId}.action" method="post" name="basic">
                            	<div class="persoanal_inp_field">
                                    ...
                                    <p>
                                    	...
                                    	<input type="text" name="userName" value="${user.userAlias }" />
                                ...
                                <div class="persoanal_inp_field">
                                    ...
                                    <input type="text" name="profCity" value="${userProf.profCity}" />
                                ...
                                <div class="persoanal_inp_field">
                                    ...
                                    <input type="text" name="profAge" value="${userProf.profAge}" />
                                </div>
								...
								<div class="persoanal_inp_field">
                                    ...
                                    <p class="inp_search"><input type="text" name="userIntro" value="${user.userIntro}"  /></p>
                                </div> 
