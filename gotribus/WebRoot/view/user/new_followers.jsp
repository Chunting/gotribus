...
<body>
	<div id="wrapper"><!--start wrapper-->
    	<div id="header"><!--start header-->
        	<div class="logo"><a name="top" href="${no_view_url}user/my.action">
            ...
            <div id="header_rgt"><!--start header_rgt-->
            	<div id="menu_bg"><div id="menu_lft"><div id="menu_rgt">
                    ...
                    <div class="header_search">
							...
							<form action="${no_view_url }user/findByName.action">
            ...
            <div id="common_maincontent"><!--start common_maincontent-->
            	<div id="follower_title"><!--start follower_title-->
                    ...
                    <div id="title_follower_row">
                    	<div id="pic_follower"><img src="${user.userPic}" alt="" width="78" height="78" /></div>
                        <div id="people_follow">
                        	<p>( <span>${followersNum }</span> ) People followed ${user.userAlias}</p>
                            <a href="${no_view_url }user/friendHome/${user.userId}.action"><img src="${domain }user/img/icon_album.jpg" alt="" width="20" height="19" /></a>
                        </div>
                    </div>
                ...
                <div id="follower_gallery_cont"><!--start follower_gallery_cont-->
                    ...
                    <c:forEach items="${friends}" var="f">
                    		<div class="follower_widget"><!--start follower_widget-->
                            	...
                            	<h3><a href="${no_view_url}user/friendHome/${f.userId}.action">
                            		${f.userAlias }
                            	</a></h3>
