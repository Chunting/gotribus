...
request.setAttribute("path2",GlobleConfig.pathPath1);
	String wish=(String)request.getAttribute("wish");
			...
			String brief=activityPic.getPicDescription().split("\\.")[0];
        	...
        	<div id="saerch_area"><!--start saerch_area-->
                ...
                <div id="social_media"><!--start social_media-->
                    ...
                    <div id="social_box"><!--start social_box-->
                        ...
                        <div class="address">
                        	<h3><%if(user1!=null){ %><a href="${path2}user/my.action"><%=user1.getUserAlias()%></a><%}else{ %><a href="${path2}user/loginForm.action">login</a><%} %></h3>
            	...
            	<div id="album_content"><!--start album_content-->
                    ...
                    <div id="gallery"><!--start gallery-->
                        ...
                        <div id="banner_pic_page">
                        	 <div align="center"><img src="${activityPics.picPath_big}" alt="" usemap="#Map"/></div>
...
var str=location.href;
        ...
        FB.ui(obj, callback);
                                ...
                                <ul>                     	
                                  <li><a href="${path2}addWishList/city/${activityId}.action">+ Track List</a></li>
