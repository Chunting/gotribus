                    ...
                    <div id="gallery"><!--start gallery-->
                        ...
                        <div id="album_img">
                          ...
                          <c:forEach items="${activityPics}" var="item">
                            <a href="${path2}activity/showPic.action?activityPicId=${item.picId}&albumName=${activityAlbum.albumName}&activityId=${activityId}&albumId=${activityAlbum.albumId}"><img src="${item.picPath}" alt="" width="192" height="192"/></a>
</c:forEach>
                        </div>
