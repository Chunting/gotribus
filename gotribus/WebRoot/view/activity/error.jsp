...
<head>
	...
	<title>Tribus_error</title>
	<meta name="description" content="" />
	<meta name="keywords" content="" />
    <link rel="stylesheet" type="text/css" media="screen,projection" href="${domain}activity/font/font.css" />
    <link rel="stylesheet" type="text/css" media="screen,projection" href="${domain}activity/styleNew.css" />
    	...
    	<div id="header"><!--start header-->
            ...
            <div id="header_rgt"><!--start header_rgt-->
            	<div id="menu_bg"><div id="menu_lft"><div id="menu_rgt">
                    <ul>
                    	<li class="current_page_item"><a href="${no_view_url}activity/index.action">EVENT</a></li>
        ...
        <div id="main_area"><!--start main_area-->
        	<div id="about_content"><!--start about_content-->
                ...
                <div id="about_box"><!--start about_box-->
                    ...
                    <p>
                    	Sorry, the resource you want to visit doesn't no longer exist ... 
                    </p>
