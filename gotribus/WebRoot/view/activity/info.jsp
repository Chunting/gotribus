...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
	...
	String lat=(String)request.getAttribute("activityLat");
	String activityLong=(String)request.getAttribute("activityLong");
	System.out.println(lat+","+activityLong);;
...
<link rel="stylesheet" type="text/css" media="screen,projection" href="${path1}activity/font/font.css" />
  ...
  <script type="text/javascript">
     ...
     var myLatlng = new google.maps.LatLng(<%=lat%>,<%=activityLong%>);
  var myOptions = {
    zoom: 12,
    center: myLatlng,
                        ...
                        <div id="product_twocol"><!--start product_twocol-->
                            ...
                            <div id="product_rgtcol"><!--start product_rgtcol-->
                                ...
                                <div class="king_social">
                                	<a href="#sfd"><img src="${path1}activity/img/icon_facebook.jpg" alt="" width="24" height="24" /></a>
                                    <a href="#"><img src="${path1}activity/img/icon_tweet.jpg" alt="" width="24" height="24" /></a>
                                </div>
...
${activityInfo.activityDetail}
                        ...
                        <div class="brief_gallery"><!--start brief_gallery-->
                          	...
                          	<h2><a href="${path2}activity/album.action?activityId=${activityId}">Activity Album</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;00000000000000000000000000000000000                  
							  <c:choose><c:when test="${flagg==1}"> 
							  <span class="STYLE1">
							  <a href="${path2}activity/addPicIndex.action?activityId=${activityId}">Upload New Picture</a></span></h2></c:when></c:choose>
                          		<div class="brief_img">
                            	<ul id="slider1"><li>
