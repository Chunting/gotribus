 ...
 String.prototype.Trim = function()
{
    ...
    if(activityDetail.length==0||activityName.length==0||activityCity.length==0||activityStreet.length==0||activitystartDate.length==0||activityFees.length==0||hidden_para2.length==0)
  ...
  <body>
  	<div id="wrapper"><!--start wrapper-->
        ...
        <div id="main_area"><!--start main_area-->
			...
			action="${path2}activity/activityEdit.action?activityId=${activity.activityId}">
                            	<div class="account_message">
                                	<div class="message_drop"></div>
                                	<div class="message_activity">
                                    	
                                       	<div class="author_speech">
                                        <textarea id="activityDetail" name="activityDetail"rows="10" cols="10" onclick="if(this.value=='Activity introduction:')(this.value='')"  onblur="if(this.value=='')(this.value='Activity introduction:')"> ${activity.activityDetail}</textarea>
                                    </div>
                                    </div>
                                </div>
                                <div class="contact_field_widget">
                                    ...
                                    <div class="text_field"><input type="text" name="activityName" id="activityName" value="${activity.activityName}"/></div>
                              </div>
                                <div class="contact_field_widget">
                                	<label>Activity street: :</label>
                                    <div class="text_field"><input type="text"  name="activityStreet" id="activityStreet" value="${activity.activityStreet}"/></div>
                                </div>
                                <div class="contact_field_widget">
                                  <label>Activity city: :</label>
                                  <div class="text_field"><input type="text" name="activityCity" id="activityCity" value="${activity.activityCity}"/></div>
                              </div>
                                <div class="contact_field_widget">
                                  <label>Activity state: :</label>
                                    <div class="text_field"><input type="text" name="activityState" id="activityState" value="${activity.activityState}"/></div>
                              </div>
                                <div class="contact_field_widget">
                                	<label>Fees:</label>
                              ...
                              <div class="contact_field_widget"></div>
                                ...
                                <div class="contact_field_widget">
                                    <div class="text_field">
                                      ...
                                      <img src="${activity.activityPic}" width="200" height="220"/>
                                          <div class="icon_edit"></div>
                                      </div>
                                      <br/>
                                      <br/>
                                      <input type="hidden" name="file_url" id="file_url" value="${activity.activityPic}" />
                                      </form>
