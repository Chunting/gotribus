                    ...
                    <div id="gallery"><!--start gallery-->
                        ...
                        <div id="contact_form_create"><!--start contact_form_create-->
                                ...
                                <div class="contact_field_widget">
                                    ...
                                    <div class="text_field"><input class="small_txt" type="text" name="activityFeesFrom" id="activityFeesFrom"/>USD</div>
                                </div>
                                <div class="contact_field_widget">
                                	<label>To:</label>
                                    <div class="text_field"><input class="small_txt" type="text" name="activityFeesTo" id="activityFeesTo"/>USD</div>
                                </div>
                                <div class="contact_field_widget">
                                	<label>Tag:</label>
                                ...
                                <div class="contact_field_widget">
                                    ...
                                    <div class="text_field">
                                    <input class="small_txt" type="text" id="activitystartDate" name="activitystartDate"/>
                                    <small>-</small>
