...
Integer activityFeesFrom=activity.getActivityFeesFrom().intValue();
Integer activityFeesTo=null;
if(activity.getActivityFeesTo()!=null){
 activityFeesTo=activity.getActivityFeesTo().intValue();}
%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Edit ${activity.activityName}</title>
 ...
 String.prototype.Trim = function()
{
    ...
    if(activityDetail.length==0||activityName.length==0||activityCity.length==0||activityStreet.length==0||activityState.length==0||activitystartDate.length==0||activityFeesFrom.length==0)
                        ...
                        <div id="contact_form_create"><!--start contact_form_create-->
                            	...
                            	<div class="account_message">
                                	...
                                	<div class="message_activity">
                                        ...
                                        <textarea name="activityDetail" id="activityDetail" rows="10" cols="10" onclick="if(this.value=='Activity introduction:')(this.value='')"  onblur="if(this.value=='')(this.value='Activity introduction:')">${activity.activityDetail}</textarea>
                                    </div>
                                    </div>
                                </div>
                                ...
                                <div class="contact_field_widget">
                                    ...
                                    <div class="text_field"><input class="small_txt" type="text" name="activityFeesFrom" id="activityFeesFrom"  value="<%=activityFeesFrom %>"/>USD</div>
                                </div>
                                <div class="contact_field_widget">
                                	<label>Fees to:</label>
                                    <div class="text_field"><input class="small_txt" type="text" name="activityFeesTo" id="activityFeesTo"  value="<%if(activityFeesTo!=null){%><%=activityFeesTo%><%} %>"/>USD</div>
                                </div>
                                <div class="contact_field_widget">
                                	<label>Tag:</label>
                              ...
                              <div class="persoanal_inp_field">
                                ...
                                <div class="contact_field_widget">
                                    <div class="text_field">
                                      ...
                                      <input type="hidden" name="file_url_middle" id="file_url_middle" value="${activity.activityPic }" />
                                       <input type="hidden" name="file_url_big" id="file_url_big" value="${activity.activityPic_big }" />
                                        <input type="hidden" name="file_url_small" id="file_url_small" value="${activity.activityPic_small }" />
                                     
                                    
                                   <form method="post" id="activityInfo" name="activityInfo" action="${path2}activity/activityEdit.action?activityId=${activity.activityId}" class="radio">
