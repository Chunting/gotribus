...
<head>
 ...
 <script type="text/javascript" src="${path1}js/jquery-1.6.2.min.js"></script>		
	...
	<script type="text/javascript" src="${path1}activity/css/js/jquery-1.8.0.min.js"></script>
    <script type="text/javascript" src="${path1}activity/css/js/create_mmb.js"></script>
            ...
            <div id="common_maincontent"><!--start common_maincontent-->
                    ...
                    <div id="gallery"><!--start gallery-->
                        ...
                        <div id="contact_form_create"><!--start contact_form_create-->
                                ...
                                <div class="contact_field_widget">
                                    ...
                                    <div class="text_field"><input type="text" class="active" value="Activity name" name="activityName" id="activityName"/></div>
                                </div>
                                <div class="contact_field_widget">
                                	
                                    <div class="text_field"><input type="text" class="active" value="Address" name="activityStreet" id="activityStreet"/></div>
                                </div>
                                <div class="contact_field_widget">
                                  
                                  <div class="text_field"><input type="text" class="active" value="City" name="activityCity" id="activityCity"/></div>
                              </div>
                                <div class="contact_field_widget">
                                  
                                    <div class="text_field"><input type="text" class="active" value="State" name="activityState" id="activityState" /></div>
                              </div>
                               <div class="contact_field_widget">
                                    <div class="text_field">
                                    <input class="small_txt" type="text" id="activitystartDate" value="Start time" name="activitystartDate"/>
                                 
                                    <input class="small_txt end" type="text" id="activityfinishDate" value="End time" name="activityfinishDate" /></div>
                                </div>
                                <div class="contact_field_widget">
                                	
                                    <input class="small_txt" type="text" value="Fees From" name="activityFeesFrom" id="activityFeesFrom"/>
                                	<input class="small_txt end" type="text" value="To:" name="activityFeesTo" id="activityFeesTo"/>
                                </div>

                                <div class="contact_field_widget">
                                    <div class="text_field tag">
                                     	<input type="text" class="active" value="Tag:" name="tag" id="tag" />
                                     	<div class="arrow"></div>
                                    </div>                 
								 </div>
				...
				enctype="multipart/form-data" target="hidden_frame_2">
                               ...
                               <div class="persoanal_inp_field">
                                	<p class="inp_search">
                                	<input class="poster" value="Activity picture" />
									<input type="file" size="12" name="myfile" class="upload"  onchange="$('#form_upload2').submit();"  />	
									</p>
