                ...
                <div id="review_lftcol"><!--start review_lftcol-->
                    ...
                    <div id="brief_main"><!--start brief_main-->
                        ...
                        <div class="brief_gallery"><!--start brief_gallery-->
                        	<h2>Snapshot &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;________________________   </h2>               
                           ...
                           <a href="${path2}activity/showPicList.action?albumId=${item.albumId}"><img src="http://localhost:8080/tribus/view/pic/2012/3/1/0.jpg" width="103"
								height="103" />  </a>
                               </c:forEach>
                                <div class="clear"></div>
                               </li></ul>
