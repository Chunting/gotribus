<%@ page language="java" import="java.util.*,model.User,model.Activity,model.ActivityClassified,vo.ActivityGoingMax,vo.UserComment,config.GlobleConfig" pageEncoding="utf-8"%>
...
function WishList(url,id){
 event2=id;
  ...
  typeId=document.getElementById("tribusClassify").value;
   document.form1.action="../user/addTribusList/city/"+typeId+"/rescourceId";
    	...
    	<div id="header"><!--start header-->
            ...
            <div id="header_rgt"><!--start header_rgt-->
            	<div id="menu_bg"><div id="menu_lft"><div id="menu_rgt">
                    <ul>
                    	<li class="current_page_item"><a href="${path2}activity/index.action">EVENT</a></li>
                    ...
                    <div class="header_search">
                    	<form action="${path2}user/searchAll.action">
                        	<p class="txt_header"><input type="text" id="search" name="search"/></p>
        	...
        	<div id="saerch_area"><!--start saerch_area-->
            	<div id="search_bg"><!--start search_bg-->
                	<form action="${path2}activity/search.action">
                    	<p class="search_text"><input type="txt1" name="searchCondition" value="Seach activity, activity time, activity location" onclick="if(this.value=='Seach activity, activity time, activity location')(this.value='')"  onblur="if(this.value=='')(this.value='Seach activity, activity time, activity location')" /></p>
      ...
      function postToFeed() {
        ...
        FB.ui(obj, callback);
                    ...
                    <div id="social_box"><!--start social_box-->
                        ...
                        <div class="address">
                        	<h3><%if(u==null){%><a href="${path2}user/loginForm.action">login</a>
									<%}else{ %>
...
<a href="${path2}activity/info.action?activityId=${item.activityId }">${item.activityName
                                ...
                                <div class="join"><small>${item.numbers} (people)</small>      
                                <a>Join in</a>
                                </div>
                            </div>
                        </div>
