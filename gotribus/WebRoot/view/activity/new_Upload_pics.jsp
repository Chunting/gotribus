	...
	<div id="wrapper"><!--start wrapper-->
		...
		<input type="hidden" value="1" name="div_container_number" />
				...
				<iframe name='hidden_frame_3' id="hidden_frame_3" style='display: none'></iframe>
                    ...
                    <div class="persoanal_inp_field">
                                	<p class="inp_search">
									<input type="file" name="myfile" class="file" value=""  onchange="$('#form_upload3').submit();"  />	
									</p>
...
<%if(!size.equals("0")){ %>									<a href="javascript:get32()">Album Existed</a><%}else{ %>Name<%} %>
				...
				<iframe name='hidden_frame_4' id="hidden_frame_4" style='display: none'></iframe>
                       ...
                       <div class="persoanal_inp_field">
                                	<p class="inp_search">
									<input type="file" name="myfile" class="file" value=""  onchange="$('#form_upload4').submit();"  />	
									</p>
...
<%if(!size.equals("0")){ %>
				...
				<iframe name='hidden_frame_5' id="hidden_frame_5" style='display: none'></iframe>
                      ...
                      <div class="persoanal_inp_field">
                                	<p class="inp_search">
									<input type="file" name="myfile" class="file" value=""  onchange="$('#form_upload5').submit();"  />	
									</p>
...
<%if(!size.equals("0")){ %>
				...
				<iframe name='hidden_frame_6' id="hidden_frame_6" style='display:none'></iframe>
                     ...
                     <div class="persoanal_inp_field">
                                	<p class="inp_search">
									<input type="file" name="myfile" class="file" value=""  onchange="$('#form_upload6').submit();"  />	
									</p>
...
<%if(!size.equals("0")){ %>
                    ...
                    <div class="clear"></div>
                   	...
                   	<c:when test="${flag==1}">
						...
						<div class="btn_contact_field1" >
                                <br/>
                               	<a href="javascript: check_blank();">Save</a>
                ...
                <script type="text/javascript">
									...
									var p1=document.getElementById("hidden_para1_small").value;
									var p2=document.getElementById("hidden_para2_small").value;
									var p3=document.getElementById("hidden_para3_small").value;
									var p4=document.getElementById("hidden_para4_small").value;
									var p5=document.getElementById("hidden_para5_small").value;
									var p6=document.getElementById("hidden_para6_small").value;
									
									var aId1=document.getElementById("albumName1").value;
									var aId2=document.getElementById("albumName2").value;
									var aId3=document.getElementById("albumName3").value;
									var aId4=document.getElementById("albumName4").value;
									var aId5=document.getElementById("albumName5").value;
									var aId6=document.getElementById("albumName6").value;
									
									var s1=document.getElementById("albumId_select1");
									var s2=document.getElementById("albumId_select2");
									var s3=document.getElementById("albumId_select3");
									var s4=document.getElementById("albumId_select4");
									var s5=document.getElementById("albumId_select5");
									var s6=document.getElementById("albumId_select6");
									
									
									var flag=0;
									if((p1!=""&&aId1!="")||(p1!=""&&s1!=null)){flag++;}
									if((p2!=""&&aId2!="")||(p2!=""&&s2!=null)){flag++;}
									if((p3!=""&&aId3!="")||(p3!=""&&s3!=null)){flag++;}
									if((p4!=""&&aId4!="")||(p4!=""&&s4!=null)){flag++;}
									if((p5!=""&&aId5!="")||(p5!=""&&s5!=null)){flag++;}
									if((p6!=""&&aId6!="")||(p6!=""&&s6!=null)){flag++;}
									if(flag!=0){
									
									getValues();
									}else{
									alert("Please uploads pictures");
									}
