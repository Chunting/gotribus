            ...
            <div id="main_content"><!--start main_content-->
            	<div id="content"><!--start content-->
                	<div id="title_my_activity"><!--start title_my_activity-->
                    	<h2>More Activity </h2>
                    	<div id="fiona_inner">
                            <img src="${user.userPic}" alt="" width="70" height="70" />
      ...
      function postToFeed() {
        ...
        FB.ui(obj, callback);
          ...
          <%} %>
                            ...
                            <a  href="${path2}activity/yourActivity.action?page=<c:choose><c:when test="${current-1 == 0}">1</c:when><c:otherwise>${current-1}</c:otherwise></c:choose>" class="prev"></a>
              <c:forEach items="${pageNumbers}" var="item">  
             <a href="activity/yourActivity.action?page=${item}">
             ${item}
             </a>&nbsp
            </c:forEach>
            
                            <a  href="${path2}activity/yourActivity.action?page=<c:choose><c:when test="${current == maxNumber}">${maxNumber}</c:when><c:otherwise>${current+1}</c:otherwise></c:choose>" class="next"></a>
                    	</div>
                </div><!--//end #content-->
                ...
                <div id="side_bar"><!--start side_bar-->
                    ...
                    <div class="widget"><!--start widget-->
                        ...
                        <div class="widget_gallery">
                        	<a href="info.action?activityId=${item.activityId }"><img src="${item.activityPic }" alt="" width=222 height=133/></a>
                            <h3><a href="info.action?activityId=${item.activityId}">${item.activityName }</a></h3>
                        </div>
                       </c:forEach>
                    ...
                    <div class="widget"><!--start widget-->
                        ...
                        <div class="widget_info">
                        	...
                        	<c:forEach items="${topTribusCity}" var="item">
                            	<li><a href="byCityTag.action?city=${item}">${item}</a></li>
                               </c:forEach>
                            </ul>
