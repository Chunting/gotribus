      ...
      function postToFeed() {
        ...
        FB.ui(obj, callback);
                    ...
                    <div id="social_box"><!--start social_box-->
                        ...
                        <div class="address">
                        	<h3><%if(user!=null){ %><a href="${path2}user/friendHome/<%=user.getUserId()%>.action"><%=user.getUserAlias()%></a><%}else{ %><a href="${path2}user/loginForm.action">login</a><%} %></h3>
            ...
            <div id="main_content"><!--start main_content-->
            	<div id="content"><!--start content-->
                	<div id="title_my_activity"><!--start title_my_activity-->
                    	<h2>More Activity </h2>
                    	<div id="fiona_inner">
                         <%if(user!=null){ %><img src="<%=user.getUserPic()%>" alt="" width="70" height="70"/><%}else{%>   <img src="${path1}activity/img/pic_activity.jpg" alt="" /><%} %>
                        	...
                        	<div class="scnd_activity_cont"><!--start scnd_activity_cont-->
                            	...
                            	<div class="activity_feature_lft"><!--start activity_feature_lft-->
                                    ...
                                    <div class="descript_info">
                                        	...
                                        	<br /> Start:<%=activity.get(i).getActivity().getActivityStartTime() %><br /> 
                                        	End:<%=activity.get(i).getActivity().getActivityFinishTime() %><br /> 
                                        	</p>
                                            <p>Fee: <%=activity.get(i).getActivity().getActivityFees()%></p>
                                        </div>
      ...
      function postToFeed() {
        ...
        FB.ui(obj, callback);
                                            ...
                                            <div class="feature_list">
                                                <ul>
              <li><a href="${path2}addWishList/city/${activityInfo.activityId}.action">+ Wish List</a></li>
                                              <li><a href="${path2}addTribusList/city/${activityInfo.activityId}.action">+ Tribus List</a></li>
                                                </ul>
                                            </div>
                                ...
                                <div class="activity_feature_rgt">
                                	...
                                	<%for(int p=0;p<activity.get(i).getUserComments().size();p++){ %>
                                        <li><span><a href ="${path2}user/friendHome/<%=activity.get(i).getUser().getUserId() %>.action"><img src="<%=activity.get(i).getUserComments().get(p).getUserPic() %>" alt="" width=34 height=34/></a></span><small>: <%=activity.get(i).getUserComments().get(p).getUserComment() %></small></li>
