...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen,projection" href="${my_local }/book/css/slider.css" />
    <link rel="stylesheet" type="text/css" href="${my_local }/movie/css/jquery.lightbox.css" media="screen" />
	...
	$(document).ready(function() {
		...
		if ($(".brief_content p").height() > '58') {
			$(".brief_content p").css("height","58");
			$(".brief_content p").css("overflow","hidden");
		}
		$(".brief_content .icon_brief").toggle(function() {
			$(".brief_content p").css("height","auto");
		},function() {		
			if ($(".brief_content p").height() > '58') {		
				$(".brief_content p").css("height","58px");
				$(".brief_content p").css("overflow","hidden");
			}
		});
...
<body>
                ...
                <div id="review_lftcol"><!--start review_lftcol-->
                    <div id="product_area"><!--start product_area-->
                        ...
                        <div id="product_twocol"><!--start product_twocol-->
                        	<div id="product_lftcol"><img src="${singlePageMain.itemPic }" alt="" width="267" height="400" /><strong><a href="${my_domain }/book/editBook/${singlePageMain.itemId }.action">Edit this book</a></strong></div>
                            <div id="product_rgtcol"><!--start product_rgtcol-->
                                ...
                                <ul class="kings_list">
                                	<li>Start Date: <c:out value="${singlePageMain.itemDate}" /></li>
                                    <li>ISBN: <c:out value="${singlePageMain.bookISBN}" /></li>
                                    <li>Author: <c:out value="${singlePageMain.bookAuthor}" /></li>
                                    <li>Book Pages: <c:out value="${singlePageMain.bookPages}" /></li>
                                </ul>
                                <div class="king_wish">
                                	<a href="javascript:void(0)" class="trackList" onClick="showPopTracked()">+ Track List</a>
                                ...
                                <div class="king_done">
                                	<a href="javascript:void(0)" class="selectOne" onClick="showPopWanted()">Wanted</a>
                                    <a href="javascript:void(0)" class="selectTwo" onClick="showPopDone()">Done</a>
                    ...
                    <div id="brief_main"><!--start brief_main-->
                    	<div class="brief_activity space_brief_activity"><!--start brief_activity-->
                            ...
                            <div class="comment_box"><!--start comment_box-->
                                <div class="brief_content">
                                    ...
                                    <div class="icon_brief"><img src="${my_local}/book/img/icon_plus.jpg" alt="" width="20" height="20" /></div>
                                </div>
                            </div><!--//end .comment_box-->
                        ...
                        <div class="just_watch"><!--start just_watch-->
                            ...
                            <ul>
                            	...
                            	<li><img src="${thisRecord.friendPic}" alt="" width="31" height="30" /><span> <c:out value="${thisRecord.friendName}"/><small>........</small><c:out value="${thisRecord.timeSpan}"/> ago</span></li>
                           		</c:forEach>
                            </ul>
                        </div><!--//end .just_watch-->
                        ...
                        <div id="kings_reivew">
                        	...
                        	<a href="${my_domain }/review/book${singlePageMain.itemId }.action">More reviews <img src="${my_local }/book/img/tripple_arrow3.jpg" alt="" /></a>
                        	</div>
                        </div>
                    </div><!--//end #brief_main-->
    ...
    <!--Wanted-->
    <div id="popup_layer_wanted" onClick="closePopWanted()"></div>
    <div id="light_box_wrapper_wanted"><!--start light_box_wrapper_wanted-->
            <div class="pop_up_cross"> <a href="javascript:void(0)" onClick="closePopWanted()"></a></div>
           	<div class="info">You have marked it wanted</div>
    </div><!--//end #light_box_wrapper_wanted-->
    
    <!--Done-->
    <div id="popup_layer_done" onClick="closePopDone()"></div>
    <div id="light_box_wrapper_done"><!--start light_box_wrapper_done-->
            <div class="pop_up_cross"> <a href="javascript:void(0)" onClick="closePopDone()"></a></div>
           	<div class="info">You have marked it done</div>
    </div><!--//end #light_box_wrapper_done-->
    
   	<!--Tracked-->
    <div id="popup_layer_tracked" onClick="closePopTracked()"></div>
    <div id="light_box_wrapper_tracked"><!--start light_box_wrapper_tracked-->
            <div class="pop_up_cross"> <a href="javascript:void(0)" onClick="closePopTracked()"></a></div>
           	<div class="info">You have tracked it</div>
    </div><!--//end #light_box_wrapper_tracked-->
    ...
    <script type="text/javascript" src="${my_local }/book/js/code.js"></script>
    <script type="text/javascript" src="${my_local }/book/js/jquery.lightbox.js"></script>
	<c:if test="${Server == 1}">
    ...
    <script src="${my_local }/book/js/smoothscroll.js" type="text/javascript"></script>
    	...
    	$(function() {
			...
			$.ajax({  
				type: "POST",  
				url: "${my_domain }/user/addWishList/book/${singlePageMain.itemId }.action",  
				data: dataString,  
			...
			$.ajax({  
				type: "POST",  
				url: "${my_domain }/user/addTribusList/book/${singlePageMain.itemId }.action",  
				data: dataString,  
				success: function(data, textStatus, jqXHR) {  
					if(data == "ok!"){
    ...
    $(".selectOne").click(function() {
     ...
     $(".selectTwo").removeClass("click_done");
          var dataString = "mark=wanted";
				$.ajax({  
				  type: "POST",  
				  url: "${my_domain}/book/markBook/${singlePageMain.itemId}.action",  
				  data: dataString,  
				  success: function() {  
				  }  
				});
    ...
    <script> 
      ...
      function postToFeed() {
		...
		if(${markWatch}==1){
			obj.name = 'I want to read this book';
		}
		if(${markWatch}==2){
			obj.name = 'I\'v read this book';
		}
