                    	...
                    	<div id="book_gallery_area"><!--start book_gallery_area-->
                        	<div class="book_gallery_lftcol"><!--start book_gallery_lftcol-->
                            	...
                            	<div class="book_gallery">
                                	...
                                	<a href="${my_domain}/book/${thisBook.bookId }.action"><img src="img/pic_book_gallery1.jpg" alt="" width="78" height="120" /></a>
                                	</c:forEach>
                                </div>
                ...
                <div id="side_bar"><!--start side_bar-->
                    ...
                    <div class="widget"><!--start widget-->
                        ...
                        <div class="widget_info">
                        	<p class="upper"><a href="${my_domain }/music/searchByTag/art.action">Arts</a>  <a  href="${my_domain }/music/searchByTag/biography.action">Biography</a>  <a href="${my_domain }/music/searchByTag/business.action">Business</a><br />
                            <a href="${my_domain }/music/searchByTag/comic.action">Comics</a>  <a href="${my_domain }/music/searchByTag/fiction.action">Fiction</a>  <a href="${my_domain }/music/searchByTag/health.action">Health</a><br/>
                        	<a href="${my_domain }/music/searchByTag/literature.action">Literature</a>  <a href="${my_domain }/music/searchByTag/rock.action">Rock</a>  <a href="${my_domain }/music/searchByTag/mystery.action">Mystery</a><br />
                       		<a href="${my_domain }/music/searchByTag/romance.action">Romance</a>  <a href="${my_domain }/music/searchByTag/travel.action">Travel</a> <a href="${my_domain }/music/searchByTag/other.action">Others</a></p>
                        </div>
                    </div><!--//end .widget-->
                    <div class="widget"><!--start widget-->
                    	<h2>Top Book List</h2>
