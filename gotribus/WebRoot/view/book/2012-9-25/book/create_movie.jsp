                        ...
                        <div id="persoanal_form"><!--start persoanal_form-->
                        	...
                        	<form action="" id="movie_edit_form">
                            	...
                            	<div class="persoanal_inp_field">
                                    <p><input type="text" value="${book.bookName }" name="bookName" class="text" /></p>
                                </div>
                                <div class="persoanal_inp_field">
                                    <p><input type="text" value="${book.bookAuthor}" name="bookAuthor" class="text" /></p>
                                </div>
                                <div class="persoanal_inp_field">                            	
                                    <p><input type="text" value="${book.bookPublishDate}" id="bookDate" name="bookDate" class="text" /></p>
                                </div>
                                <div class="persoanal_inp_field">                             	
                                    <p><input type="text" value="${book.bookISBN}" name="bookISBN" class="text" /></p>
                                </div>   
                                <div class="persoanal_inp_field">                           	
                                    <p><input type="text" id="bookPage" value="bookPage" name="bookPage" class="text" /></p>
                                </div>
