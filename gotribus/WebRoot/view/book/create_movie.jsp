...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen,projection" href="${my_local }/book/css/jquery.ui.all.css" />
    <link rel="stylesheet" type="text/css" media="screen,projection" href="${my_local }/book/css/demos.css" />
    <link rel="stylesheet" type="text/css" media="screen,projection" href="${my_local }/book/css/jquery.base.css" />
    <link rel="stylesheet" type="text/css" media="screen,projection" href="${my_local }/book/css/jquery.theme.css" />
    <script type="text/javascript" src="${my_local }/book/js/jquery-1.8.0.min.js"></script>
    <script type="text/javascript" src="${my_local }/book/js/create_mmb.js"></script>
    <!--[if lt IE 10]>
            	...
            	<div id="album_content" class="create_list"><!--start album_content-->
                    <div id="gallery"><!--start gallery-->
                        <div id="persoanal_form"><!--start persoanal_form-->
                        		...
                        		<p><textarea rows="15" cols="80" class="intro" name="bookBrief">Brief Introduction:</textarea></p>
                        	...
                        	<form action="" id="movie_edit_form">
                            	...
                            	<div class="persoanal_inp_field">
                                    <p><input type="text" value="Book Name" id="bookName" name="bookName" class="text act" onfocus(this.value='') onblur(this.value='movie name') 
                                    /></p>
                                </div>
                                <div class="persoanal_inp_field">
                                    <p><input type="text" value="Author" id="bookAuthor" name="bookAuthor" class="text act" onfocus(this.value='') onblur(this.value='movie name') /></p>
                                	<span class="info">Please separate authors by commas.</span>
                                </div>
                                <div class="persoanal_inp_field">                            	
                                    <p><input type="text" value="Publish Date" id="bookDate" name="bookDate" class="text act" onfocus(this.value='') onblur(this.value='movie name') /></p>
                                	<span class="info">YYYY-MM-DD</span>
                                </div>
                                <div class="persoanal_inp_field">                             	
                                    <p><input type="text" value="ISBN" id="bookISBN" name="bookISBN" class="text act" onfocus(this.value='') onblur(this.value='movie name') /></p>
                                </div>   
                                <div class="persoanal_inp_field">                           	
                                    <p><input type="text" id="bookPage" value="Pages" name="bookPage" class="text act" onfocus(this.value='') onblur(this.value='movie name') /></p>
                                </div>
