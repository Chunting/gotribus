...
<body>
            ...
            <div id="common_maincontent"><!--start common_maincontent-->
            	<div id="review_main"><!--start review_main-->
                	<div id="review_lftcol"><!--start review_lftcol-->
                        ...
                        <div id="dreadcrumbs">
                        	<a href="${my_domain}/review/book.action">Review &gt;</a> <a href="${my_domain}/review/book${singleReviewMain.itemId}.action"><c:out value="${singleReviewMain.itemName}" /> &gt;</a> <c:out value="${singleReviewMain.commentTitle}" />
                        </div>
                        ...
                        <div class="review_post"><!--start review_post-->
                            <div class="review_ratting space_rating"><!--start review_ratting-->
                                ...
                                <div class="rating_icon">
                                	<a href="#"><img src="${my_local}/book/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
                                    <a href="#"><img src="${my_local}/book/img/blue_star1.jpg" alt="" width="20" height="19"  /></a>
                                    <a href="#"><img src="${my_local}/book/img/blue_star1.jpg" alt="" width="20" height="19"  /></a>
                                    <a href="#"><img src="${my_local}/book/img/blue_star1.jpg" alt="" width="20" height="19"  /></a>
                                    <a href="#"><img src="${my_local}/book/img/blue_star2.jpg" alt="" width="20" height="19"  /></a>
                                </div>
                            </div><!--//end .review_ratting-->
                        </div><!--//end .review_post-->
                        <div class="games_info"><!--start games_info-->
                        	<div class="games_social">
                                ...
                                <div class="games_media">
                                	<a href="#"><img src="${my_local}/book/img/icon_facebook2.jpg" alt="" width="15" height="15" /></a>
                                    <a href="#"><img src="${my_local}/book/img/icon_tweet2.jpg" alt="" width="16" height="15" /></a><!--
                                    <a href="#">+ Wish List</a>
                        ...
                        <div class="realted_article"><!--start realted_article-->
                            ...
                            <ul>
                            	...
                            	<li><a href="${my_domain }/review/bookReview/${thisArticle.itemId}.action"><c:out value="${thisArticle.itemName}" />, <c:out value="${thisArticle.commentTitle}" /> <c:out value="${thisArticle.commentDate}" /></a></li>
                            	</c:forEach>
                            </ul>
                            	...
                            	<div class="comment_first_content"><!--start comment_first_content-->
                                    ...
                                    <div class="author_total_rgt">
                                        ...
                                        <div class="author_icon">
                                        	<span><img src="${my_local}/book/img/icon_album.jpg" alt="" width="20" height="19" /></span>
                    ...
                    <div id="review_side_bar"><!--start review_side_bar-->
                    	<div class="review_btn2"><a href="${my_domain }/review/bookReviewAction/${singleReviewMain.itemId }.action">Create a Review</a></div>
                    	<div class="review_feature">
                        	<img src="${singleReviewMain.itemPic}" alt="" width="142" height="217"/>
                            <h3><c:out value="${singleReviewMain.itemName}" /> Page <a href="${my_domain }/book/${singleReviewMain.itemId }.action"><img src="${my_local}/book/img/tripple_arrow3.jpg" alt="" /></a></h3>
                        </div>
                        <div class="rating_widget">
                        	<h2>Seach by Rating <span>(<a href="#"><c:out value="${singleReviewMain.commentNumber}" /></a>)</span></h2>
                            <ul>
                            	<li>
                                	<a href="#"><img src="${my_local}/book/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${my_local}/book/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${my_local}/book/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${my_local}/book/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${my_local}/book/img/icon_rating1.jpg" alt="" /></a>
                                ...
                                <li>
                                    ...
                                    <a href="#"><img src="${my_local}/book/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${my_local}/book/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${my_local}/book/img/icon_rating2.jpg" alt="" /></a>
    ...
    <script src="${my_local}/book/js/jquery-1.js" type="text/javascript"></script>
    <script src="${my_local}/book/js/easy-editable-text.js" type="text/javascript"></script>
	<script type="text/javascript">
		...
		function add_comment(){
			...
			$.ajax({  
				type: "POST",  
				url: "${my_domain}/review/addBookComment/"+${commentId}+".action",  
				data: dataString,  
				success: function() {  
				}  
			});
