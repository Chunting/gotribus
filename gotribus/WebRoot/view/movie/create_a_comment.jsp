                    ...
                    <div id="gallery"><!--start gallery-->
                        ...
                        <div id="create_comment"><!--start create_comment-->
                            ...
                            <div class="comment_rating">
                            	...
                            	<input type="hidden" id="item_rate_id" value="${movieId}" />
                            </div>
                            <div class="comment_btn">
                            	<a href="javascript: comment_action('${my_domain }/review/submitMovieReview/${movieId }.action');">Upload</a>
                                <a class="comment_btn2" href="javascript: comment_action('${my_domain }/review/draftMovieReview/${movieId }.action');">Save as Draft</a>
                            </div>
