	...
	function searchCallback(data) {
		if (data.total != 0) {			
			 ...
			 $.each(movies, function(index, movie) {		
			   ...
			   $("div.result_list ul").find("span:eq("+indx+")").append('<li><a href="'+movie.links.alternate+'" target="_blank">'+ movie.title +'</a> edited by </li>');			
			 });
			 ...
			 $("div.result_list ul").append('<li><a href="###">' + info + '</a></li>');
		}
	}
	</script>	
