...
<head>
	...
	<title>Tribus_Search_Movie_Result_movie</title>
        ...
        <div id="main_area"><!--start main_area-->
            ...
            <div id="common_maincontent"><!--start common_maincontent-->
                	...
                	<div id="search_lftcol"><!--start search_lftcol-->
                        ...
                        <div id="gallery_book"><!--start gallery_book-->
                        	...
                        	<div class="book_feature">
                            	<a href="${my_domain }/music/${thisResult.itemId}.action"><img src="${thisResult.itemPic }" alt="" width="122" height="184" /></a>
                ...
                <div id="review_side_bar"><!--start review_side_bar-->
                	<div class="review_btn"><a href="${my_domain }/music/createMusic.action">Create a Music</a></div>
