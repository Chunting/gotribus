                    	...
                    	<div class="review_post"><!--start review_post-->
                            ...
                            <div class="review_ratting"><!--start review_ratting-->
                                ...
                                <div class="rating_icon">
									<c:choose>
                                		<c:when test="${singlePageMain.userRate>=0.5 && singlePageMain.userRate<1.5}">                                		
		                               ...
		                               <c:when test="${singlePageMain.userRate>=1.5 && singlePageMain.userRate<2.5}">
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting2.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting2.jpg" alt="" width="20" height="19" /></a>
		                               ...
		                               <c:when test="${singlePageMain.userRate>=2.5 && singlePageMain.userRate<3.5}">
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting2.jpg" alt="" width="20" height="19" /></a>
		                               ...
		                               <c:when test="${singlePageMain.userRate>=3.5 && singlePageMain.userRate<4.5}">
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
		                               ...
		                               <c:when test="${singlePageMain.userRate>=4.5}">
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
