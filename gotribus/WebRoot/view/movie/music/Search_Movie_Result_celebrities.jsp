        ...
        <div id="main_area"><!--start main_area-->
        	<div id="saerch_area"><!--start saerch_area-->
            	<div id="search_bg"><!--start search_bg-->
                	<form action="${my_domain }/music/search/2.action" id="single_search_bar" name="single_search_bar">
            	...
            	<div id="main_search_content"><!--start main_search_content-->
                	<div id="search_lftcol"><!--start search_lftcol-->
                    	<div class="search_title"><!--start search_title-->
                            ...
                            <div class="book_btn">
                            	<a href="${my_domain }/music/search/1.action?single_search_name=${searchName }">Movies</a>
