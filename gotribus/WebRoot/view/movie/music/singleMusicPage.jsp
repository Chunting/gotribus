                ...
                <div id="social_media"><!--start social_media-->
                    ...
                    <div id="social_box"><!--start social_box-->
                    	<div id="message">
                            ...
                            <a href="${my_local }/user/police.action"><img src="${my_local }/music/img/icon_message2.jpg" alt="" width="22" height="22" /></a>
                            <a href="${my_local }/user/about.action"><img src="${my_local }/music/img/icon_message3.jpg" alt="" width="22" height="22" /></a>
                        ...
                        <div id="product_twocol"><!--start product_twocol-->
                            ...
                            <div id="product_rgtcol"><!--start product_rgtcol-->
                                ...
                                <div class="king_wish">
                                	...
                                	<a href="#" class="tribusList">+ Tribus List</a>
                                </div>
                               ...
                               <c:if test="${myRate>0}">
								...
								<div class="king_blue_rated">
                                	...
                                	<span>Your rate is: <c:out value="${myRate}" /></span>
