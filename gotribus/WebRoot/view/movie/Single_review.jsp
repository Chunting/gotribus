...
<head>
    ...
    <script type="text/javascript" src="${my_local}/movie/js/jquery.min.js"></script>
    <script type="text/javascript" src="${my_local}/movie/js/Single_review.js"></script>
    <!--[if lt IE 10]>
...
<body>
            ...
            <div id="common_maincontent"><!--start common_maincontent-->
            	<div id="review_main"><!--start review_main-->
                	<div id="review_lftcol"><!--start review_lftcol-->
                            ...
                            <div class="review_ratting"><!--start review_ratting-->
                                ...
                                <div class="rating_icon">
		                                		...
		                                		<c:when test="${singleReviewMain.itemRating>=0.5 && singleReviewMain.itemRating<1.5}">
				                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting.jpg" alt="" width="12" height="12" /></a>
				                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting2.jpg" alt="" width="12" height="12" /></a>
				                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting2.jpg" alt="" width="12" height="12" /></a>
				                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting2.jpg" alt="" width="12" height="12" /></a>
				                                    <a href="#"><img src="${my_local}/movie/img/icon_ratting2.jpg" alt="" width="12" height="12" /></a>
				                               </c:when>
                        ...
                        <div class="review_post"><!--start review_post-->
                            <div class="review_ratting space_rating"><!--start review_ratting-->
                                ...
                                <div class="rating_icon">
									<c:choose>
                                		<c:when test="${singleReviewMain.userRate>=0.5 && singleReviewMain.userRate<1.5}">
		                               ...
		                               <c:when test="${singleReviewMain.userRate>=1.5 && singleReviewMain.userRate<2.5}">
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star2.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star2.jpg" alt="" width="20" height="19" /></a>
		                               ...
		                               <c:when test="${singleReviewMain.userRate>=2.5 && singleReviewMain.userRate<3.5}">
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star2.jpg" alt="" width="20" height="19" /></a>
		                               ...
		                               <c:when test="${singleReviewMain.userRate>=3.5 && singleReviewMain.userRate<4.5}">
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                               ...
		                               <c:when test="${singleReviewMain.userRate>=4.5}">
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="${my_local}/movie/img/blue_star1.jpg" alt="" width="20" height="19" /></a>
                        ...
                        <div class="games_info"><!--start games_info-->
                        	<div class="games_social">
                                ...
                                <div class="games_media">
			                		<div id='fb-root'></div>
			                    	<a><img src="${my_local}/movie/img/icon_facebook.jpg" alt="" width="16" height="15" /></a>
			                       	<a id='msg'></a>
                                    <a href="#"><img src="${my_local}/movie/img/icon_tweet2.jpg" alt="" width="16" height="15" /></a><!--
                                    <a href="#">+ Wish List</a>
                        ...
                        <div class="realted_article"><!--start realted_article-->
                            ...
                            <ul>
                            	...
                            	<li><a href="${my_domain }/review/movieReview/${thisArticle.itemId}.action"><c:out value="${thisArticle.itemName}" />, <c:out value="${thisArticle.commentTitle}" /> <c:out value="${thisArticle.commentDate}" /></a></li>
                            	</c:forEach>
                            </ul>
                        ...
                        <div id="comment_box_area"><!--start comment_box_area-->
                            	...
                            	<div class="comment_first_content"><!--start comment_first_content-->
                                    ...
                                    <div class="author_total_rgt">
                                        ...
                                        <div class="author_icon">
                                        	<span><img src="${my_local }/movie/img/icon_album.jpg" alt="" width="20" height="19" /></span>
                            ...
                            <div class="comment_box bg_differ" id="comment_box_show"><!--start comment_box-->
                            ...
                            <c:if test="${r.index % 2 != 0}">
                            <div class="comment_box" id="comment_box_show"><!--start comment_box-->
                            	<div class="comment_scnd_content"><!--start comment_scnd_content-->
                                	<div class="pic_author">
                                        <img src="${thisQuickComment.userPic}" alt="" width="72" height="72" />
                                    </div>
                    ...
                    <div id="review_side_bar"><!--start review_side_bar-->
                    	<div class="review_btn"><a href="${my_domain }/review/movieReviewAction/${singleReviewMain.itemId }.action">Create a Review</a></div>
                    	<div class="review_feature">
                        	<img src="${singleReviewMain.itemPic}" alt="" width="142" height="217"/>
                            <h3><c:out value="${singleReviewMain.itemName}" /> Page <a href="${my_domain }/movie/${singleReviewMain.itemId }.action"><img src="${my_local}/movie/img/tripple_arrow3.jpg" alt="" /></a></h3>
                        </div>
                        <div id="dreadcrumbs">
                        	<a href="${my_domain}/review/movie.action">Review &gt;</a> <a href="${my_domain}/review/movie${singleReviewMain.itemId}.action"><c:out value="${singleReviewMain.itemName}" /> &gt;</a> <c:out value="${singleReviewMain.commentTitle}" />
                        </div>
                        <div class="rating_widget">
                        	<h2>Seach by Rating <span>(<a href="#"><c:out value="${singleReviewMain.commentNumber}" /></a>)</span></h2>
                            <ul>
                            	<li>
                                	<a href="#"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" /></a>
                                ...
                                <li>
                                    ...
                                    <a href="#"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${my_local}/movie/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${my_local}/movie/img/icon_rating2.jpg" alt="" /></a>
    ...
    <script src="${my_local}/movie/js/jquery-1.js" type="text/javascript"></script>
    <script src="${my_local}/movie/js/easy-editable-text.js" type="text/javascript"></script>
	<script type="text/javascript">
		...
		function add_comment(){
			...
			$.ajax({  
				type: "POST",  
				url: "${my_domain}/review/addMovieComment/"+${commentId}+".action",  
				data: dataString,  
				success: function() {  
				}  
			});
      ...
      function postToFeed() {
        ...
        var obj = {
          ...
          picture: '${thisQuickComment.userPic}',
          name: '${thisQuickComment.commentTitle}',
