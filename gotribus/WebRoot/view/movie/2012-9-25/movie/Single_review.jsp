...
<head>
    ...
    <script type="text/javascript" src="js/Single_review.js"></script>
    <!--[if lt IE 10]>
                	...
                	<div id="review_lftcol"><!--start review_lftcol-->
                    	<div class="review_post"><!--start review_post-->
                            ...
                            <div class="review_ratting"><!--start review_ratting-->
                                ...
                                <h4><a href="${my_domain }/review/movieReviewAction/${singleReviewMain.itemId }.action">Create a Review</a></h4>
                                <div class="rating_icon">
												<c:choose>
		                                		<c:when test="${singleReviewMain.itemRating>=0.5 && singleReviewMain.itemRating<1.5}">
				                                    <a href="#"><img src="img/blue_star1.jpg" alt="" width="12" height="12" /></a>
				                                    <a href="#"><img src="img/blue_star2.jpg" alt="" width="12" height="12" /></a>
				                                    <a href="#"><img src="img/blue_star2.jpg" alt="" width="12" height="12" /></a>
				                                    <a href="#"><img src="img/blue_star2.jpg" alt="" width="12" height="12" /></a>
				                                    <a href="#"><img src="img/blue_star2.jpg" alt="" width="12" height="12" /></a>
				                               </c:when>
                                ...
                                <div class="rating_icon">
									<c:choose>
                                		<c:when test="${singleReviewMain.userRate>=0.5 && singleReviewMain.userRate<1.5}">
		                                    <a href="#"><img src="img/blue_star1.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="img/blue_star2.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="img/blue_star2.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="img/blue_star2.jpg" alt="" width="20" height="19" /></a>
		                                    <a href="#"><img src="img/blue_star2.jpg" alt="" width="20" height="19" /></a>
		                               </c:when>
                        ...
                        <div class="games_info"><!--start games_info-->
                        	<div class="games_btm_icon"><img src="${my_local}/movie/img/icon_album.jpg" alt="" width="20" height="19"/></div>
