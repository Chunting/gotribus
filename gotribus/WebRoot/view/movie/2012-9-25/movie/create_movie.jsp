...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen,projection" href="css/jquery.ui.all.css" />
    <link rel="stylesheet" type="text/css" media="screen,projection" href="css/demos.css" />
    <link rel="stylesheet" type="text/css" media="screen,projection" href="css/jquery.base.css" />
    <link rel="stylesheet" type="text/css" media="screen,projection" href="css/jquery.theme.css" />
    <script type="text/javascript" src="js/jquery-1.8.0.min.js"></script>
    <script type="text/javascript" src="js/create_mmb.js"></script>
    <!--[if lt IE 10]>
            	...
            	<div id="album_content" class="create_list"><!--start album_content-->
                    <div id="gallery"><!--start gallery-->
                        <div id="persoanal_form"><!--start persoanal_form-->
                        		...
                        		<p><textarea rows="15" cols="80" class="intro" name="bookBrief"><c:out value = "${book.bookBrief}" /></textarea></p>
                        	...
                        	<form action="" id="movie_edit_form">
                            	...
                            	<div class="persoanal_inp_field">
                                    <p><input type="text" value="${movie.movieName}" name="bookName" class="text" /></p>
                                </div>
                                <div class="persoanal_inp_field">
                                    <p><input type="text" value="${movie.movieDirector}" name="bookAuthor" class="text" /></p>
                                </div>
                                <div class="persoanal_inp_field">                            	
                                    <p><input type="text" value="${movie.movieActor}" id="bookDate" name="bookDate" class="text" /></p>
                                </div>
                                <div class="persoanal_inp_field">                             	
                                    <p><input type="text" value="${movie.movieRegion}" name="bookISBN" class="text" /></p>
                                </div>   
                                <div class="persoanal_inp_field">                           	
                                    <p><input type="text" id="bookPage" value="Release Date" name="bookPage" class="text" /></p>
                                </div>
                                <div class="persoanal_inp_field">                           	
                                    <p><input type="text" id="rating" value="Rating" name="bookPage" class="text" /></p>
                                </div>
                                
                               	<div class="persoanal_inp_field">
                             		<p><span class="arrow"></span><input type="text" id="category" value="category" name="category" class="text" /></p>                             
                                	<div class="bookTag">
