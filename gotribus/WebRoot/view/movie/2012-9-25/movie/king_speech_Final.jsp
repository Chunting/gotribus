...
<head>
	...
	<title>Tribus_king's speech_Final</title>
                ...
                <div id="review_lftcol"><!--start review_lftcol-->
                    <div id="product_area"><!--start product_area-->
                        ...
                        <div id="product_twocol"><!--start product_twocol-->
                        	<div id="product_lftcol"><img src="img/pic_king.jpg" alt="" width="313" height="417" /><strong><a href="#">Edit this movie</a></strong></div>
                            <div id="product_rgtcol"><!--start product_rgtcol-->
                            	<div class="kings_rating">
                                	<span>Rating:</span>
                                    <a href="#"><img src="img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
                                    <a href="#"><img src="img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
                                    <a href="#"><img src="img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
                                    <a href="#"><img src="img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
                                    <a href="#"><img src="img/icon_ratting2.jpg" alt="" width="20" height="19" /></a>
                                </div>
                                <ul class="kings_list">
                                	<li>Start Date: 2012-3-9 19:30 P.M.</li>
                                    <li>End Date: 2012-3-20 00:00</li>
                                    <li>PLace: Chicago 1901 West Madison Street</li>
                                    <li>Starter:</li>
                                    <li>Type: Music</li>
                                    <li>Fees: 150 D</li>
                                </ul>
                    ...
                    <div id="brief_main"><!--start brief_main-->
                        ...
                        <div class="just_watch"><!--start just_watch-->
                        	<h5>Just watched :</h5>
                            <ul>
                            	<li><img src="img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                                <li><img src="img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                                <li><img src="img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                                <li><img src="img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                                <li><img src="img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                        ...
                        <div class="movie_img"><!--start movie_img-->
                            ...
                            <ul id="slider1"><li>
                            	<img src="img/pic_kings1.jpg" alt="" width="124" height="81" />
                                <img src="img/pic_kings2.jpg" alt="" width="124" height="81" />
                                <img src="img/pic_kings3.jpg" alt="" width="124" height="82" />
                                <img src="img/pic_kings4.jpg" alt="" width="124" height="82" />
                                <img src="img/pic_kings5.jpg" alt="" width="79" height="83" />
                                <div class="clear"></div>
                                </li></ul>
                            </div>
                        </div><!--//end .movie_img-->
                        <div class="video_box"><!--start video_box-->
                        	...
                        	<div class="video_box_cont"><!--start video_box_cont-->
                            	...
                            	<img src="img/pic_kings6.jpg" alt="" width="185" height="121"/>
                                <div class="play_side">
                        ...
                        <div class="video_box"><!--start video_box-->
                        	<div class="video_box_cont"><!--start video_box_cont-->
                            	<div class="btn_play"><a href="#"><img src="img/btn_play.jpg" alt="" width="18" height="18" /></a></div>
                            	<img src="img/pic_kings7.jpg" alt="" width="186" height="102"  />
                                <div class="play_side">
                        ...
                        <div id="kings_reivew">
                            <div class="review_box"><!--start review_box-->
                                ...
                                <div class="review_title_area"><!--start review_title_area-->
                                    <div class="review_small_img">
                                        <img src="img/pic_review_small_1.jpg" alt="" width="31" height="30" />
                                        <a href="#"><img src="img/black_arrow.jpg" alt="" width="9" height="16" /></a>
                                    </div>
                                    <div class="review_title_rgt">
                                        <h3><a href="#">The Hunger Games violence is 'justified' says star</a></h3>
                                        <span>Name</span>
                                    </div>
                                </div><!--//end .review_title_area-->
                                <div class="rating_feature"><!--strat rating_feature-->
                                    <div class="rating_feature_descript">
                                        <p>Jennifer Lawrence, the star of The Hunger Games, has defended the scenes of violence in 
                                        the film which has been given a '12A' rating only after some footage was cut ...</p>
                                    </div>
                                    <div class="rating_star">
                                        <div class="rating_star_lft">
                                            <a href="#"><img src="img/icon_star1.png" alt="" width="12" height="12" /></a>
                                            <a href="#"><img src="img/icon_star1.png" alt="" width="12" height="12" /></a>
                                            <a href="#"><img src="img/icon_star1.png" alt="" width="12" height="12" /></a>
                                            <a href="#"><img src="img/icon_star1.png" alt="" width="12" height="12" /></a>
                                            <a href="#"><img src="img/icon_star2.png" alt="" width="12" height="12" /></a>
                                        </div>
                                        <div class="rating_star_rt"><a href="#"><img src="img/tripple_arrow4.png" alt="" width="27" height="9" /></a></div>
                                    </div>
                            ...
                            <div class="review_box"><!--start review_box-->
                                <div class="review_title_area"><!--start review_title_area-->
                                    <div class="review_small_img">
                                        <img src="img/pic_review_small_2.jpg" alt="" width="31" height="31" />
                                        <a href="#"><img src="img/black_arrow.jpg" alt="" width="9" height="16" /></a>
                                    </div>
                                    <div class="review_title_rgt">
                                        <h3><a href="#">Auto Show</a></h3>
                                        <span>Name</span>
                                    </div>
                                </div><!--//end .review_title_area-->
                                <div class="rating_feature"><!--strat rating_feature-->
                                    <div class="rating_feature_descript">
                                        <p>Auto Show<br />Chicago McCormick Place 2301 S Lake Shore Dr. Chicago, Illinois<br />60616</p>
                                    </div>
                                    <div class="rating_star">
                                        <div class="rating_star_lft">
                                            <a href="#"><img src="img/icon_star1.png" alt="" width="12" height="12" /></a>
                            ...
                            <div class="review_box"><!--start review_box-->
                                <div class="review_title_area"><!--start review_title_area-->
                                    <div class="review_small_img">
                                        <img src="img/pic_review_small_3.jpg" alt="" width="31" height="31" />
                                        <a href="#"><img src="img/black_arrow.jpg" alt="" width="9" height="16" /></a>
                                    </div>
                                    <div class="review_title_rgt">
                                        <h3><a href="#">The Black Keys are hitting the road !!!</a></h3>
                                        <span>Name</span>
                                    </div>
                                </div><!--//end .review_title_area-->
                                <div class="rating_feature"><!--strat rating_feature-->
                                    <div class="rating_feature_descript">
                                        <p>Two of music’s hardest-hitting bands are teaming up this spring for a massive arena tour. 
                                        In support of their new album, El Camino, The Black Keys are hitting the road with UK  rockers Arctic Monkeys.</p>
                                    </div>
                                    <div class="rating_star">
                                        <div class="rating_star_lft">
                                            <a href="#"><img src="img/icon_star1.png" alt="" width="12" height="12" /></a>
