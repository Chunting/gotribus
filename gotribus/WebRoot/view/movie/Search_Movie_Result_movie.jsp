...
<head>
	...
	<script type="text/javascript">
		var apikey = "qrwjk9ctg24btzzse3g4kq9v";
		var baseUrl = "http://api.rottentomatoes.com/api/public/v1.0";
		
		// construct the uri with our apikey
		var moviesSearchUrl = baseUrl + '/movies.json?apikey=' + apikey;
		var query = '<c:out value="${searchName}" />';
		...
		function searchCallback(data) {
			if (data.total != 0) {			
				 ...
				 $.each(movies, function(index, movie) {
				   ...
				   $("#gallery_book").find(".book_feature:eq("+index+")").append('<a href="${my_domain}/movie/'+ movie.id + '.action" target="_blank"><img src="' + movie.posters.profile + '" alt="" width="122" height="184" /></a>');
//				   $("#gallery_book").find(".book_feature:eq("+index+")").append('<a href="'+movie.links.alternate+'" target="_blank"><img src="' + movie.posters.profile + '" alt="" width="122" height="184" /></a>');
				   $("#gallery_book").find(".book_feature:eq("+index+")").append('<h3><a href="###">' + movie.title + '</a></h3>');
				 });
        ...
        <div id="main_area"><!--start main_area-->
            ...
            <div id="common_maincontent"><!--start common_maincontent-->
            	<div id="main_search_content"><!--start main_search_content-->
                	<div id="search_lftcol"><!--start search_lftcol-->
                    	<div class="search_title"><!--start search_title-->
                            ...
                            <div class="book_btn">
                            	<a class="select_book" href="#">Movies</a>
                                <!--<a href="${my_domain }/movie/search/2.action?single_search_name=${searchName }">Celebrities</a>
                        ...
                        <div id="gallery_book"><!--start gallery_book-->
                       	<!--<c:forEach items="${searchResults}" var="thisResult">
                        	<div class="book_feature">
                            	<a href="${my_domain }/movie/${thisResult.itemId}.action"><img src="${thisResult.itemPic }" alt="" width="122" height="184" /></a>
                                <h3><a href="${my_domain }/movie/${thisResult.itemId}.action"><c:out value="${thisResult.itemName}" /></a></h3>
                                <span><c:out value="${thisResult.itemRate}" /></span>
                            </div>
                            </c:forEach>--><!--
                            
                            <strong><a href="${my_domain }/movie/createMovie.action">Create new movie</a></strong>
                            --><div class="clear"></div>
                ...
                <div id="review_side_bar"><!--start review_side_bar-->
                	<div class="review_btn_add"><a href="${my_domain }/movie/createMovie.action">Add It</a></div>
