...
<head>
    ...
    <script type="text/javascript" src="${my_local }/movie/js/jquery-1.8.0.min.js"></script>
    <script type="text/javascript" src="${my_local }/movie/js/create_mmb.js"></script>
    <!--[if lt IE 10]>
            	...
            	<div id="album_content" class="create_list"><!--start album_content-->
                    <div id="gallery"><!--start gallery-->
                        <div id="persoanal_form"><!--start persoanal_form-->                      		
                       		<h3 class="info_title">Add a Movie</h3>
                       		<p><textarea rows="15" cols="80" class="intro" name="movieBrief">Brief Introduction:</textarea></p>
                        	...
                        	<form action="" id="movie_edit_form">
                            	...
                            	<div class="persoanal_inp_field">
                                    <p><input type="text" value="Movie Name" name="movieNameOriginal" class="text act" onfocus(this.value='') onblur(this.value='movie name') /></p>
                                </div>
                                <div class="persoanal_inp_field">
                                    <p><input type="text" value="Director" name="movieDirector" id="movieDirector" class="text act" onfocus(this.value='') onblur(this.value='movie name') /></p>
                                	<span class="info">Please separate directors by commas.</span>
                                </div>
                                <div class="persoanal_inp_field">                            	
                                    <p><input type="text" value="Actor" id="movieActor" name="movieActor" class="text act" onfocus(this.value='') onblur(this.value='movie name') /></p>
                                	<span class="info">Please separate actors by commas.</span>
                                </div>
                                <div class="persoanal_inp_field">                             	
                                    <p><input type="text" value="Region" name="movieRegion" id="movieRegion" class="text act" onfocus(this.value='') onblur(this.value='movie name') /></p>
                                </div>   
                                <div class="persoanal_inp_field">                           	
                                    <p><input type="text" value="Release Date" name="movieDate" id="movieDate" class="text act" onfocus(this.value='') onblur(this.value='movie name') /></p>
                                	<span class="info">YYYY-MM-DD</span>
                                </div>
                                <div class="persoanal_inp_field">                           	
                                    <p><input type="text" value="Rating" name="movieRating" class="text act" onfocus(this.value='') onblur(this.value='movie name') /></p>
                                </div>
