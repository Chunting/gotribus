            ...
            <div id="common_maincontent"><!--start common_maincontent-->
            	<div id="review_main"><!--start review_main-->
                	<div id="review_lftcol"><!--start review_lftcol-->
                    	<div class="review_post"><!--start review_post-->
                            ...
                            <div class="review_ratting"><!--start review_ratting-->
                                ...
                                <h4><a href="${my_domain }/review/bookReviewAction/${singleReviewMain.itemId }.action">Create a Review</a></h4>
                        ...
                        <div class="games_info"><!--start games_info-->
                        	<div class="games_btm_icon"><img src="${my_local}/book/img/icon_album.jpg" alt="" width="20" height="19"/></div>
                    ...
                    <div id="review_side_bar"><!--start review_side_bar-->
                    	<div class="review_btn"><a href="${my_domain }/review/bookReviewAction/${singleReviewMain.itemId }.action">Create a Review</a></div>
