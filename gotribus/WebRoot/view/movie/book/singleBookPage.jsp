                ...
                <div id="review_lftcol"><!--start review_lftcol-->
                    <div id="product_area"><!--start product_area-->
                        ...
                        <div id="product_twocol"><!--start product_twocol-->
                        	<div id="product_lftcol"><img src="${singlePageMain.itemPic }" alt="" width="313" height="417" /><strong><a href="${my_domain }/book/editBook/${singlePageMain.itemId }.action">Edit this book</a></strong></div>
